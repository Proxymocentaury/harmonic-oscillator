...
def f_teorica(x_a2):
    return 1 - (1/24)*x_a2 + (3/640)*x_a2**2 - (5/7168)*x_a2**3
...
print("=========================================")
print(f"Intercetta al continuo (c0) = {c0:.6f} ± {perr[0]:.6f} (Atteso: 1.000000)")
print(f"Coefficiente ord 1 (c1)     = {c1:.6f} ± {perr[1]:.6f} (Atteso: 1/24=0.041667)")
...
plt.ylabel(r'$E$ (Energia efficace)', fontsize=11)
